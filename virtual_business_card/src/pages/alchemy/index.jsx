...
function App() {
  ...
  icons.set("Instagram", {
    icon: InstagramIcon,
    url: "https://www.instagram.com/alchemy_hs/",
  });
  icons.set("WhatsApp", {
    icon: WhatsAppIcon,
    url: "https://wa.me/+27680702280",
  });
  icons.set("Make Booking", {
    icon: AddBoxIcon,
    url: "https://www.fresha.com/book-now/alchemy-hair-studio-d5njalgl/all-offer?share&pId=512488",
  });
